...
class ConnectionManager {
  ...
  getConnection(options) {
    ...
    return promise.then(() => {
      console.log(`[beforeAcquire] using: ${this.pool.using}, waiting: ${this.pool.waiting}, available: ${this.pool.available}`)
  ...
  releaseConnection(connection) {
    return Promise.try(() => {
      ...
      console.log(`[afterRelease] using: ${this.pool.using}, waiting: ${this.pool.waiting}, available: ${this.pool.available}`)
